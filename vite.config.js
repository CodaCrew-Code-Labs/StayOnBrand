    ...
    return ({
        plugins: [
            vue({
                template: {
                    compilerOptions: {
                        isCustomElement: function (tag) { return tag === 'iconify-icon'; }
                    }
                }
            }),
            tailwindcss(),
            {
                ...
                transformIndexHtml: {
                    ...
                    handler: function (html) {
                        ...
                        return html.replace('<meta name="viewport"', "<meta http-equiv=\"Content-Security-Policy\" content=\"".concat(csp, "\" />\n    <meta http-equiv=\"Permissions-Policy\" content=\"bluetooth=(), camera=(), microphone=(), geolocation=(), usb=()\" />\n    <meta name=\"viewport\""));
                    }
                }
            }
        ],

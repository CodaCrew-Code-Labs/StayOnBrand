      ...
      <div class="max-w-screen-2xl mx-auto text-center">
        ...
        >
          ...
          >
            ...
            <p class="text-sm font-semibold text-brand-black">Service Lifetime</p>
          ...
          >
            ...
            <p class="text-sm font-semibold text-brand-black">Core Features</p>
            <p class="text-xs text-brand-gray mt-1">Access to features at time of purchase</p>
          </div>
          <div
          ...
          >
            ...
            <p class="text-sm font-semibold text-brand-black">Non-Transferable</p>
            <p class="text-xs text-brand-gray mt-1">Cannot be resold, shared, or assigned</p>
          </div>
        </div>
      </div>
    </section>
              ...
              >
                ...
                <div class="relative z-10">
                  <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p class="text-brand-bg/50 text-xs">Terms & Limitations</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-2 gap-3">
                    ...
                    >
                      <p class="text-brand-bright text-2xl font-bold font-mono">9</p>
                      <p class="text-brand-bg/60 text-xs">Sections</p>
                    </div>
                    <div
                      class="bg-brand-bg/10 backdrop-blur rounded-xl p-3 border border-brand-bg/10"
                    >
                      <p class="text-brand-bright text-2xl font-bold font-mono">1x</p>
                      <p class="text-brand-bg/60 text-xs">Payment</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="space-y-2">
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <p class="text-xs text-brand-gray">Payment terms</p>
                    </div>
                  </RouterLink>
                  <RouterLink
                    to="/privacy"
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <p class="text-xs text-brand-gray">Data handling</p>
                    </div>
                  </RouterLink>
                </div>
              </div>
                ...
                >
                  <div class="p-4 rounded-xl bg-brand-teal/10 border border-brand-teal/30 mb-4">
                    <p class="text-sm text-brand-black font-semibold">
                      <span class="text-brand-teal">Important:</span> "Lifetime" refers to the
                      <strong>lifetime of the Services</strong>, not the lifetime of any individual
                      user, device, company, or legal entity.
                    </p>
                  </div>
                  <p>
